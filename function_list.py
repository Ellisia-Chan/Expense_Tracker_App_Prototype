...
class AddEntryWindow:
    ...
    def create_widgets(self):
        ...
        self.ent_category['validatecommand'] = (self.ent_category.register(lambda text: text.isdigit() and text.isalpha() or text == ""), '%S')
    ...
    def get_entries(self):
       if self.entries:
            ...
            for entry in self.entries:
                ...
                formatted_entry = (entry[1], entry[3], formatted_amount) 
                formatted_entries.append((formatted_entry, text_color, category))
